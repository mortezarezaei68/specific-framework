...
{
    public class CreateCustomerTransactionalCommandHandler : ITransactionalCommandHandlerMediatR<CreateCustomerCommand,
        CreateCustomerResponseCommand>
    {
        ...
        public Task<CreateCustomerResponseCommand> Handle(CreateCustomerCommand request,
            CancellationToken cancellationToken, RequestHandlerDelegate<CreateCustomerResponseCommand> next)
        {
